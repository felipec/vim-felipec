...
hi Todo guifg=#ff8080 ctermfg=210 guibg=#333333 ctermbg=237 gui=bold,italic cterm=bold,italic
...
hi MatchParen guifg=#ff8080 ctermfg=210 guibg=#503030 ctermbg=238 gui=bold cterm=bold
hi NonText guifg=#666600 ctermfg=58 guibg=#333333 ctermbg=237 gui=NONE cterm=NONE
...
hi Folded guifg=#8080ff ctermfg=105 guibg=#333333 ctermbg=237 gui=italic cterm=italic
hi FoldColumn guifg=#8080ff ctermfg=105 guibg=#101010 ctermbg=233 gui=NONE cterm=NONE
hi Pmenu guifg=#efefef ctermfg=255 guibg=#333333 ctermbg=237 gui=NONE cterm=NONE
hi PmenuSel guifg=#8080ff ctermfg=105 guibg=#333333 ctermbg=237 gui=bold,reverse cterm=bold,reverse
...
hi WildMenu guifg=#8080ff ctermfg=105 guibg=#333333 ctermbg=237 gui=bold,reverse cterm=bold,reverse
...
hi GitGutterAdd guifg=#80ff80 ctermfg=120 guibg=#333333 ctermbg=237 gui=NONE cterm=NONE
hi GitGutterDelete guifg=#ff8080 ctermfg=210 guibg=#333333 ctermbg=237 gui=NONE cterm=NONE
hi GitGutterChange guifg=#8080ff ctermfg=105 guibg=#333333 ctermbg=237 gui=NONE cterm=NONE
...
hi TabLineSel guifg=#8080ff ctermfg=105 guibg=#333333 ctermbg=237 gui=NONE cterm=NONE
hi StatusLine guifg=#333333 ctermfg=237 guibg=#efefef ctermbg=255 gui=reverse cterm=reverse
hi StatusLineNC guifg=#333333 ctermfg=237 guibg=#808080 ctermbg=244 gui=reverse cterm=reverse
hi StatusLineTerm guifg=#333333 ctermfg=237 guibg=#80ff80 ctermbg=120 gui=reverse cterm=reverse
hi StatusLineTermNC guifg=#333333 ctermfg=237 guibg=#808080 ctermbg=244 gui=reverse cterm=reverse
hi VertSplit guifg=#333333 ctermfg=237 guibg=#efefef ctermbg=255 gui=reverse cterm=reverse
